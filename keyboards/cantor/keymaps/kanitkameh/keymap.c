...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LEFT_MODS] = LAYOUT_split_3x6_3(
        ...
        _______,  LCTL_T(KC_1), LALT_T(KC_2),  LGUI_T(KC_3),  LSFT_T(KC_4), KC_5,                             _______, _______, _______, _______, _______, _______,
        _______,  _______,  _______,  _______,  KC_ESC,  KC_EQL,                              _______, _______, _______, _______, _______, _______,
                                                      _______, _______, _______,          _______, _______, _______
    ),
    [RIGHT_MODS] = LAYOUT_split_3x6_3(
        _______,  _______,  _______,  _______,  _______,  _______,                             KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
        _______,  _______,  _______,  _______,  _______,  _______,                             KC_6, RSFT_T(KC_7), RGUI_T(KC_8), RALT_T(KC_9), RCTL_T(KC_0), _______,
        _______,  _______,  _______,  _______,  _______,  _______,                             KC_MINUS, KC_QUOT, KC_BSLS, KC_LBRC, KC_RBRC, _______,
                                                      _______, _______, _______,          _______, _______, _______
    ),
