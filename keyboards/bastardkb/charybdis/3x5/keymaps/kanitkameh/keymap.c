...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MMO_TOGGLE] = LAYOUT(
        ...
        _______,  _______,  _______,  _______,  _______,                             _______, _______, _______, _______, _______,
        _______,  _______,  _______,  _______,  _______,                             _______, _______, _______, _______, _______,
                                                      TG(MMO_MOUSE), _______, _______,          _______, _______
    ),
    [MMO_MOUSE] = LAYOUT(
        _______,  _______,  _______,  _______,  _______,                             KC_1,     KC_2,     KC_3,     KC_4,     KC_5,
        _______,  _______,  _______,  _______,  _______,                             MS_BTN5,  MS_BTN1,  MS_BTN2,  MS_BTN3,  MS_BTN4,
    ...
    [VIM] = LAYOUT(
        ...
        _______,  _______,        DELETE,  _______,  _______,                         KC_LEFT, KC_DOWN, KC_UP,  KC_RIGHT, _______,
...
void leader_end_user(void) {
    ...
    if (leader_sequence_three_keys(KC_M, KC_M, KC_O)) {
        layer_invert(MMO_TOGGLE);
    }
    // for setting the OS
